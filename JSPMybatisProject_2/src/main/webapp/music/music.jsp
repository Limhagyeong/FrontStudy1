...
<body>
	<div class="container">
		...
		<form method="post" action="music.jsp">
			<table class="table">
				<tr>
					<td><input type="checkbox" name="fd" value="T">노래명 <input
						type="checkbox" name="fd" value="S">가수명 <input
						type="checkbox" name="fd" value="A">앨범명 <input type="text"
						name="ss" size="20" class="input-sm"> <input type="submit"
						value="검색" class="btn-sm btn-primary"> <%--
							노래 / 가수 / 앨범
							WHERE title LIKE 
							WHERE singer LIKE
							WHERE album LIKE
