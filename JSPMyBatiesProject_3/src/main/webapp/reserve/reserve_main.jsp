...
<tr>
	...
	<span class="btn btn-xs btn-info foods" data-no="2">양식</span>
	<span class="btn btn-xs btn-warning foods" data-no="3">중식</span>
	<span class="btn btn-xs btn-success foods" data-no="4">일식</span>
	</td>
	</tr>
	<tr>
	<td>
	...
	<tr>
	<td>
	 <img src="../reserve/noimg.png" style="width: 100%" id="food_image">
	</td>
	</tr>
	<tr>
							...
							<tr style="display: none" id="ok">
								<td class="text-center">
									<form method="post" action="../reserve/reserve_ok.do">
										<input type="hidden" name="fno" id="fno"> <input
											type="hidden" name="rday" id="rday"> <input
											type="hidden" name="rtime" id="rtime"> <input
											type="hidden" name="rinwon" id="rinwon">
