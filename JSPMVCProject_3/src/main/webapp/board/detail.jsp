...
<body>
	...
	<div class="row">
		...
		<td clospan="3">${vo.subject }</td>
		</tr>
		<tr>
		<td colspan="4" class="text-letf" valign="top" height="200">
			<pre style="whith-space: pre-wrap;border:none;background-color: white;">${vo.content }</pre>
		</td>
		</tr>
		<tr>
