...
<body>
	<div class="wrapper row3">
		<main class="container clear">
			...
			<div class="row row1" style="height: 500px;"></div>
			<table class="table">
			<tr>
				...
				<tr>
				<td colspan="4" class="text-left" valign="top" height="200"><pre style="white-sapce: pre-wrap; border: none;background-color: white;">${vo.content }</pre></td>
				</tr>
				<tr>
				<td colspan="4" class="text-right">
					<a href="../databoard/update.do?no=${vo.no }" class="btn btn-success btn-xs">수정</a>
					<span class="btn btn-info btn-xs" id="delete" >삭제</span>
					<a href="../databoard/list.do" class="btn btn-warning btn-xs">목록</a>
					</td>
				</tr>
