			...
			<table class="table">
				<tr>
					<td width="40%" class="text-center" rowspan="8"><img
						style="width: 100%" id="poster" src="${vo.poster }"></td>
					<td colspan="2">
						<h3 id="name">${vo.name }&nbsp;<span style="color: orange">${vo.score }</span>
						</h3>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<c:if test="${sessionScope.id!=null }">
						...
						class="btn btn-xs btn-warning">목록</a>
					</td>
				</tr>
			</table>
			...
			<c:if test="${sessionScope.id!=null }">
				<table class="table">
					...
					<tr>
						<td>
							<form method=post>
								<textarea rows="4" cols="45" style="float: left"></textarea>
								<input type=submit value="댓글쓰기" class="btn btn-sm btn-danger" 
								style="height: 86px; float: left;">
							</form>
						</td>
					</tr>
				</table>
